...
describe('Problem', function() {
  ...
  describe('.translate()', function() {
    beforeEach(function() {
      this.oldLang = $.i18n.lng();
      return $.i18n.setLng('rot13');
    });
    afterEach(function() {
      return $.i18n.setLng(this.oldLang);
    });
    return it('translates messages with line numbers, error types, and placeholders', function() {
...
Gnetrg n havg.\
`;
      return expect(Problem.prototype.translate(english)).toEqual(rot13);
    });
  });
