...
describe('EnrollmentsView', function() {
  ...
  beforeEach(function() {
    ...
    for (let i = 0; i < this.view.members.fakeRequests.length; i++) {
      const request = this.view.members.fakeRequests[i];
  ...
  describe('For low priority leads', function() {
    ...
    describe('shows the starter license upsell', function() {
      ...
      it('when only subscription prepaids exist', function() {
        ...
        this.view.prepaids.trigger('sync');
        this.view.render();

        return expect(this.view.$('a[href="/teachers/starter-licenses"]').length).toBe(1);
      });

      it('when active starter licenses exist', function() {
        this.view.prepaids.set([]);
        this.view.prepaids.add(factories.makePrepaid({
      ...
      it('when expired starter licenses exist', function() {
        this.view.prepaids.set([]);
        this.view.prepaids.add(factories.makePrepaid({
          type: 'starter_license',
      ...
      return it('when no prepaids exist', function() {
        this.view.prepaids.set([]);
