...
const template = require('templates/play/level/modal/infinite_loop');
  ...
  InfiniteLoopModal = class InfiniteLoopModal extends ModalView {
    static initClass() {
      ...
      this.prototype.events = {
        ...
        'click #restart-level-infinite-loop-confirm-button'() { return Backbone.Mediator.publish('level:restart', {}); },
