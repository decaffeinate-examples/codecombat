      ...
      for (let group in e.propGroups) {
        ...
        for (let prop of Array.from(props)) {
          ...
          if (__guard__(doc != null ? doc.snippets : undefined, x => x[e.language])) {
            ...
            content = __guard__(__guard__(replacement != null ? replacement.snippets : undefined, x2 => x2[e.language]), x1 => x1.code) || doc.snippets[e.language].code;
            if (/loop/.test(content) && level.get('moveRightLoopSnippet')) {
              ...
              content = (() => { switch (e.language) {
                case 'python': return 'loop:\n    self.moveRight()\n    ${1:}';
                case 'javascript': return 'loop {\n    this.moveRight();\n    ${1:}\n}';
            ...
            if (/loop/.test(content) && level.isType('course', 'course-ladder')) {
              ...
              content = (() => { switch (e.language) {
                ...
                case 'javascript': return content.replace(/loop/, 'while (true)');
            ...
            if (doc.userShouldCaptureReturn) {
              ...
              entry.captureReturn = (() => { switch (e.language) {
                case 'javascript': return 'var ' + varName + ' = ';
