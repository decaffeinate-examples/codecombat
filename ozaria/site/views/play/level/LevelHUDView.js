...
const template = require('templates/play/level/hud');
const prop_template = require('templates/play/level/hud_prop');
  ...
  LevelHUDView = class LevelHUDView extends CocoView {
    ...
    createProperties() {
      ...
      for (let i = 0; i < iterable.length; i++) {
        const prop = iterable[i];
        const pel = this.createPropElement(prop);
