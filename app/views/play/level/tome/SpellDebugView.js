...
module.exports = (SpellDebugView = (function() {
  SpellDebugView = class SpellDebugView extends CocoView {
    ...
    constructor(options) {
      ...
      for (let className in serializedClasses) {
        const serializedClass = serializedClasses[className];
    ...
    stringifyValue(value, depth) {
      ...
      if (isArray) {
        ...
        for (let key of Array.from(value.apiProperties != null ? value.apiProperties : _.keys(value))) {
