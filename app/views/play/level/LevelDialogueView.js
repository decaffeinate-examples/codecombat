...
const template = require('templates/play/level/level-dialogue-view');
  ...
  LevelDialogueView = class LevelDialogueView extends CocoView {
    ...
    setMessage(message, mood, responses) {
      ...
      if (responses) {
        ...
        for (let response of Array.from(responses)) {
          const button = $('<button class="btn btn-small banner"></button>').text(response.text);
