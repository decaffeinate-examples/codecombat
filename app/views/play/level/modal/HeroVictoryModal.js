...
module.exports = (HeroVictoryModal = (function() {
  HeroVictoryModal = class HeroVictoryModal extends ModalView {
    ...
    onAchievementsLoaded() {
      ...
      for (let thangTypeOriginal of Array.from(thangTypeOriginals)) {
      ...
      if (me.get('hourOfCode')) {
        ...
        if (enough && !tooMuch && !me.get('hourOfCodeComplete')) {
          const pixelCode = (() => { switch (gameDevHoc) {
            ...
            case 'game-dev-hoc-2': return 'code_combat_gamedev2';
    ...
    afterRender() {
      ...
      for (let original in this.thangTypes) { const hero = this.thangTypes[original]; this.playSelectionSound(hero, true); }  // Preload them
