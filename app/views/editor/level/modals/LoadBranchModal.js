...
const template = require('templates/editor/level/modal/load-branch-modal');
...
module.exports = (LoadBranchModal = (function() {
  LoadBranchModal = class LoadBranchModal extends ModalView {
          ...
          (() => {
            ...
            for (var patch of Array.from(branch.get('patches'))) {
              ...
              if (applied) {
                ...
                for (let key of Array.from(postLoadChange.keys())) {
                  if (!toApply.has(key)) {
    ...
    renderSelectedBranch() {
      ...
      return (() => {
        const result = [];
        for (let patch of Array.from(this.selectedBranch.get('patches'))) {
    ...
    loadBranch({deleteBranch}) {
      ...
      for (let patch of Array.from(branch.get('patches'))) {
        ...
        for (let key of Array.from(currentModel.keys())) {
