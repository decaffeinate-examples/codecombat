...
const template = require('templates/editor/level/tasks-tab');
...
const defaultTasks = [
  ...
  {name: 'Write Lua sample code.', types: notWebDev, optional: true, complete(level) { return level.getSampleCode().lua; }},
  {name: 'Write Java sample code.', types: notWebDev, optional: true, complete(level) { return level.getSampleCode().java; }},
  {name: 'Write C++ sample code.', types: notWebDev, optional: true, complete(level) { return level.getSampleCode().cpp; }},
  {name: 'Write CoffeeScript sample code.', types: notWebDev, optional: true, complete(level) { return level.getSampleCode().coffeescript; }},
  {name: 'Write Lua solution.', types: notWebDev, optional: true, complete(level) { return _.find(level.getSolutions(), {language: 'lua'}); }},
  {name: 'Write Java solution.', types: notWebDev, optional: true, complete(level) { return _.find(level.getSolutions(), {language: 'java'}); }},
  {name: 'Write C++ solution.', types: notWebDev, optional: true, complete(level) { return _.find(level.getSolutions(), {language: 'cpp'}); }},
  {name: 'Write CoffeeScript solution.', types: notWebDev, optional: true, complete(level) { return _.find(level.getSolutions(), {language: 'coffeescript'}); }}
];
