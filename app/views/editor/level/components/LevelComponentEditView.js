...
const template = require('templates/editor/level/component/level-component-edit-view');
...
module.exports = (LevelComponentEditView = (function() {
  LevelComponentEditView = class LevelComponentEditView extends CocoView {
    ...
    onComponentSettingsEdited() {
      ...
      for (let key in this.componentSettingsTreema.data) {
    ...
    buildConfigSchemaTreema() {
      ...
      if (configSchema.properties) {
        ...
        for (let prop of Array.from(propertyNames)) {
