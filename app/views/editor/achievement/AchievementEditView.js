...
const template = require('templates/editor/achievement/edit');
    ...
    constructor(options, achievementID) {
      ...
      this.listenToOnce(this.achievement, 'sync', function() {
        return (() => {
          let left;
          const result = [];
          for (let levelOriginal of Array.from((left = __guard__(this.achievement.get('rewards'), x => x.levels)) != null ? left : [])) {
