...
const template = require('templates/editor/delta');
...
module.exports = (DeltaView = (function() {
  DeltaView = class DeltaView extends CocoView {
    ...
    constructor(options) {
      ...
      for (let modelName of ['model', 'headModel', 'comparisonModel']) {
    ...
    filterDeltas(deltas) {
      ...
      for (let delta of Array.from(deltas)) {
        let skip = false;
        for (let skipPath of Array.from(this.skipPaths)) {
