...
module.exports = (CampaignLevelView = (function() {
  CampaignLevelView = class CampaignLevelView extends CocoView {
    static initClass() {
      ...
      this.prototype.template = require('templates/editor/campaign/campaign-level-view');
    ...
    updateGraphCheckbox(e) {
      ...
      for (let graph of Array.from(this.analytics.graphs)) {
        for (let line of Array.from(graph.lines)) {
