...
const template = require('templates/editor/modal/new-model-modal');
...
module.exports = (NewModelModal = (function() {
  NewModelModal = class NewModelModal extends ModalView {
    ...
    makeNewModel() {
      ...
      if (this.properties != null) { for (let key in this.properties) { const prop = this.properties[key]; model.set(key, prop); } }
      return model;
    }
