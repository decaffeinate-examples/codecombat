...
const I18nVerifierComponent = Vue.extend({
  ...
  watch: {
    ...
    selectedLevelSlugs() {
      this.loading = true;
      const promises = [];
      for (let slug of Array.from(this.selectedLevelSlugs)) {
  ...
  methods: {
    ...
    getProblems: co.wrap(function*(levelSlug) {
      ...
      for (let problem of Array.from(newProblems)) {
    ...
    compareStrings(problems) {
      ...
      return problems.forEach(problem => {
        ...
        for (let regex of Array.from(this.otherRegexes)) {
...
module.exports = (I18nVerifierView = (function() {
  I18nVerifierView = class I18nVerifierView extends RootComponent {
    ...
    destroy() {
      ...
      return $.i18n.setLng(me.get('preferredLanguage'));
    }
  };
