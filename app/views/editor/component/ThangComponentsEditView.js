...
const template = require('templates/editor/component/thang-components-edit-view');
...
module.exports = (ThangComponentsEditView = (function() {
  ThangComponentsEditView = class ThangComponentsEditView extends CocoView {
    ...
    loadComponents(components) {
      return (() => {
        const result = [];
        for (let componentRef of Array.from(components)) {
    ...
    onComponentsRemoved() {
      ...
      if (thangTypeComponents = this.thangType != null ? this.thangType.get('components') : undefined) {
        for (let thangTypeComponent of Array.from(thangTypeComponents)) {
      ...
      while (true) {
        ...
        for (let componentRef of Array.from(_.values(componentMap))) {
          ...
          for (let dependency of Array.from(componentModel.get('dependencies') || [])) {
      ...
      for (let subview of Array.from(_.values(this.subviews))) {
    ...
    onComponentsAdded() {
      ...
      while (true) {
        ...
        for (let componentRef of Array.from(_.values(componentMap))) {
          ...
          for (let dependency of Array.from((componentModel != null ? componentModel.get('dependencies') : undefined) || [])) {
    ...
    onConfigChanged(e) {
      ...
      for (let thangComponent of Array.from(this.components)) {
    ...
    onSelectComponent(e, nodes) {
      ...
      while (componentsToCheck.length) {
        ...
        for (let otherComponentRef of Array.from(this.components)) {
          ...
          for (let dependency of Array.from(otherComponent.get('dependencies', true))) {
      ...
      // highlight them
      for (let child of Array.from(_.values(this.componentsTreema.childrenTreemas))) {
    ...
    checkForMissingSystems() {
      ...
      return (() => {
        const result3 = [];
        for (let system of Array.from(componentSystems)) {
    ...
    onThangTypeKindChanged(e) {
      ...
      return (() => {
        const result = [];
        for (let component of Array.from(defaultComponents)) {
