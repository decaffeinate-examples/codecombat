...
const template = require('templates/courses/classroom-view');
...
const popoverTemplate = require('templates/courses/classroom-level-popover');
...
module.exports = (ClassroomView = (function() {
  ClassroomView = class ClassroomView extends RootView {
    ...
    initialize(options, classroomID) {
      ...
      return window.tracker != null ? window.tracker.trackEvent('Students Class Loaded', {category: 'Students', classroomID}, ['Mixpanel']) : undefined;
    }
    ...
    onLoaded() {
      ...
      for (let user of Array.from(this.users.models)) {
    ...
    classStats() {
      ...
      for (let level of Array.from(this.levels.models)) { var left;
