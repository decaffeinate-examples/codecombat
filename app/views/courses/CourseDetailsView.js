...
const template = require('templates/courses/course-details');
...
module.exports = (CourseDetailsView = (function() {
  CourseDetailsView = class CourseDetailsView extends RootView {
    ...
    onClickPlayLevel(e) {
      ...
      if (window.tracker != null) {
        window.tracker.trackEvent('Students Class Course Play Level', {category: 'Students', courseID: this.courseID, courseInstanceID: this.courseInstanceID, levelSlug}, ['Mixpanel']);
      }
      if (level.isType('course-ladder')) {
