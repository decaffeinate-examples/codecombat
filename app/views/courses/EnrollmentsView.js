...
const template = require('templates/courses/enrollments-view');
...
module.exports = (EnrollmentsView = (function() {
  EnrollmentsView = class EnrollmentsView extends RootView {
    ...
    decideUpsell() {
      ...
      const shouldUpsell = me.useStripe() && !skipUpsellDueToExistingLicenses && (this.state.get('leadPriority') === 'low');
