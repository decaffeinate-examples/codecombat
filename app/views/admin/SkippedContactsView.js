...
const SkippedContactInfo = {
  ...
  computed: {
    noteData() {
      ...
      if (this.skippedContact.intercomUrl) { noteData += `intercom_url: ${this.skippedContact.intercomUrl}\n`; }
      if (this.skippedContact.intercomLastSeen) { noteData += `intercom_lastSeen: ${this.skippedContact.intercomLastSeen}\n`; }
      if (this.skippedContact.intercomSessionCount) { noteData += `intercom_sessionCount: ${this.skippedContact.intercomSessionCount}\n`; }
