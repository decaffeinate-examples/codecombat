...
const template = require('templates/i18n/i18n-edit-model-view');
...
module.exports = (I18NEditModelView = (function() {
  I18NEditModelView = class I18NEditModelView extends RootView {
    ...
    getRenderData() {
      ...
      for (let index = 0; index < this.translationList.length; index++) { const result = this.translationList[index]; result.index = index; }
    ...
    onSubmitPatch(e) {
      ...
      const collection = _.string.underscored(this.model.constructor.className);
