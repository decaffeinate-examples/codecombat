        ...
        if (i18n = propDoc.i18n) {
          ...
          if (_.isObject(propDoc.description)) {
            for (progLang in propDoc.description) {
              ...
              this.wrapRow(`${propDoc.name} description (${progLang})`, ['description', progLang], description, __guard__(i18n[lang] != null ? i18n[lang][progLang] : undefined, x => x.description), path, 'markdown');
            }
          ...
          if (context = propDoc.context) {
            for (key in context) {
              value = context[key];
              this.wrapRow(`${propDoc.name} context value`, ['context', key], value, __guard__(i18n[lang] != null ? i18n[lang].context : undefined, x1 => x1[key]), path);
            }
          }
        }
        ...
        if (i18n = propDoc.returns != null ? propDoc.returns.i18n : undefined) {
          ...
          if (_.isObject(d)) {
            for (progLang in d.description) {
              ...
              this.wrapRow(`${propDoc.name} return val (${progLang})`, ['description', progLang], description, __guard__(i18n[lang] != null ? i18n[lang][progLang] : undefined, x2 => x2.description), path, 'markdown');
            }
            ...
            if (i18n = argDoc.i18n) {
              ...
              if (_.isObject(argDoc.description)) {
                for (progLang in argDoc.description) {
                  ...
                  this.wrapRow(`${propDoc.name} arg description ${argDoc.name} (${progLang})`, ['description', progLang], description, __guard__(i18n[lang] != null ? i18n[lang][progLang] : undefined, x3 => x3.description), path, 'markdown');
                }
